if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("erm what the sigma GET OUT", 0)
    return
end
...
CMDs[#CMDs + 1] = {NAME = 'infinitejump / ifj', DESC = 'Allows you to jump before hitting the ground'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfj', DESC = 'Disables infjump'}
...
CMDs[#CMDs + 1] = {NAME = 'schb / scripthubv3', DESC = 'use script from the guy'}
wait()
...
addcmd("inpa", {"infinitejump"}, function(args, speaker)
...
addcmd("ninf", {"uninfinitejump", "noinfjump", "noinfinitejump"}, function(args, speaker)
	if infJump then infJump:Disconnect() end
	infJumpDebounce = false
end)
...
addcmd('tpk', {'teleportwalk'}, function(args, speaker)
	tpwalking = true
